...
def build_openai_oauth_post_update_payload(
    ...
    status: str = DEFAULT_OPENAI_ACCOUNT_STATUS,
) -> dict:
    ...
    payload = {
        ...
        "status": str(status or DEFAULT_OPENAI_ACCOUNT_STATUS).strip().lower(),
        "extra": {
...
def complete_openai_oauth_account_creation(
    *,
    ...
    pending_session: PendingOpenAIOAuthSession,
    auth_input: str,
    target_status: str = DEFAULT_OPENAI_ACCOUNT_STATUS,
) -> dict:
    ...
    return {
        ...
        "group_ids": list(pending_session.group_ids),
        "concurrency": pending_session.concurrency,
        "target_status": str(target_status or DEFAULT_OPENAI_ACCOUNT_STATUS).strip().lower(),
        "create_url": url,
